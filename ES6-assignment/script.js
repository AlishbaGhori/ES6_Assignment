...
// // Create a new square with a side of 5
...
// console.log(numbers); // Output the array to the console

// for (let i = 0; i < numbers.length; i++) {
//   console.log(numbers[i]); // Use a for loop to iterate through the array and output each value to the console
// }
